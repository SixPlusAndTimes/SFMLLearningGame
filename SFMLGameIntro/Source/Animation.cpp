...
void Animation::update(sf::Time dt) 
{
    ...
    while (mElapsedTime >= timePerframe && ((mCurrentFrame <= mNumFrames) || mRepeat))
    {
        ...
        // if we reach the end of one row, move to next row
        ...
        // if need repeat the animation, reset CurrentFrame to zero
        // other wise just increase the CurrentFrame until exit the loop
        if (mRepeat)
        {
